...
const { pass_key } = require('../secrets');
...
module.exports.sendMail = async function sendMail(str, data) {
  ...
  let transporter = nodemailer.createTransport({
    ...
    auth: {
      user: "khandanish36408@gmail.com", // generated ethereal user
      pass: pass_key, // generated ethereal password
    },
  });
  let eSubj, eHtml;
  if (str == "signup") {
  ...
  let info = await transporter.sendMail({
    from: '"FoodApp 🥗" <khandanish36408@gmail.com>', // sender address
